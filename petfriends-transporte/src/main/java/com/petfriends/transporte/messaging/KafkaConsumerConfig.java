...
/**
 * QUESTÃO 3.3 — Configuração do tratamento de mensagens do Transporte.
 * Mesma ideia da config do Almoxarifado, mas tipada para PedidoDespachadoEvent.
 */
@EnableKafka
@Configuration
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, PedidoDespachadoEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, PedidoDespachadoEvent.class.getName());
