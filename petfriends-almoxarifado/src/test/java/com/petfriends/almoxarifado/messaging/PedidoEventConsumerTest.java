...
class PedidoEventConsumerTest {
    ...
    @BeforeEach
    void setUp() {
        consumer = new PedidoEventConsumer(itemEstoqueRepository, kafkaTemplate);
    }
    ...
    void aoReceberPedidoFechado_deveReservarItens_e_publicarPedidoReservadoEvent() {
        ...
        // evento publicado no tópico correto
        ...
        assertThat(publicado.correlationId()).isNotNull();
    ...
    void aoReceberPedidoFechado_comDoisItens_deveReservarAmbos_e_publicarEventoCompleto() {
        ...
        PedidoFechadoEvent evento = new PedidoFechadoEvent(
                pedidoId, UUID.randomUUID(), "Maria",
    ...
    @Test
    void aoReceberPedidoFechado_comSkuInexistente_deveLancarIllegalStateException() {
        PedidoFechadoEvent evento = new PedidoFechadoEvent(
        ...
        assertThatThrownBy(() -> consumer.aoReceberPedidoFechado(evento))
